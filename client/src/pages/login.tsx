  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f5f4ee]">
      ...
      <div className="flex-grow flex flex-col px-6 py-6 items-center">
        ...
        <h1 className="text-2xl font-bold mb-1 text-left w-full">Login to your account</h1>
        
        <div className="text-sm text-gray-500 mb-6 text-left w-full">
          Don't have an account? <button className="text-[#6a2c8e] font-semibold" onClick={() => setLocation("/signup")}>Sign Up</button>
        </div>
        ...
        <form className="w-full space-y-4" onSubmit={handleLogin}>
          ...
          <div className="flex justify-end">
            <button type="button" className="text-[#6a2c8e] text-sm font-medium">
              Forgot Password?
            </button>
          </div>
          ...
          <Button 
            type="submit" 
            className="w-full py-6 mt-2 rounded-full bg-[#6a2c8e] hover:bg-[#5a2277]"
          >
            Login
          </Button>
        </form>
